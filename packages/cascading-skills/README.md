...
project/.pi/settings.json    → skills: ["project-reviewer"]
Result                       → only ["project-reviewer"]  (code-reviewer lost!)
```
...
cd ~/projects/work/project-alpha/
pi
```
...
└── Work/
    └── .pi/
        ├── settings.json           # skills: ["project-reviewer"]
        └── skills/
            └── project-reviewer/   # project developer skills
        │
        └── MyProject/
            └── .pi/
                ├── settings.json   # skills: ["markdown-formatter"]
                └── skills/         # project-specific skills
                    └── markdown-formatter/
```

Starting `pi` from `~/Work/MyProject/` gives you ALL skills from all three levels.
